      ...
      <div class="report-grid">
        <ReportCard title="Balance General" icon="account_balance_wallet">
          <div class="values-grid">
            ...
            />
            <FinancialValue 
              value={data.resumen.ingresosMes} 
              label="Ingresos del Mes" 
              trend="up"
            />
            <FinancialValue 
              value={data.resumen.egresosMes} 
            ...
            <FinancialValue 
              ...
              trend={data.resumen.variacionPatrimonio > 0 ? 'up' : data.resumen.variacionPatrimonio < 0 ? 'down' : 'neutral'}
            />
          </div>
        </ReportCard>
        ...
        {#each data.metas.items as meta, i}
          <ReportCard title={meta.nombre} icon="flag">
            ...
            <ProgressBar 
              ...
              variant={meta.progreso / meta.objetivo >= 0.8 ? 'success' : meta.progreso / meta.objetivo >= 0.5 ? 'default' : 'warning'}
            />
          </ReportCard>
        {/each}
